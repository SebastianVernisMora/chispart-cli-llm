...
class APIError(Exception):
    ...
    def __init__(self, message: str, api_name: str = None, status_code: int = None, response_data: dict = None):
...
class UniversalAPIClient:
    ...
    async def chat_completions_async(self, messages: List[Dict], model: str, **kwargs) -> Dict:
        """
